...
```sh
pi install git:github.com/paoloanzn/pi-black@v0.84.1-cc2.1.224.3
```
...
```sh
curl -fsSL https://github.com/paoloanzn/pi-black/releases/latest/download/install.sh | PI_BLACK_RELEASE=v0.84.1-cc2.1.224.3 sh
```
